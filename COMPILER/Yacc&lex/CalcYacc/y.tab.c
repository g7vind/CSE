...
static const char *const yytname[] =
{
  ...
  "MINUS", "MULTIPLY", "DIVIDE", "LPAREN", "RPAREN", "'\\n'", "$accept",
  "calculation", "expression", "term", "factor", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* calculation: calculation expression '\n'  */
#line 14 "y.y"
                                { printf("Result: %d\n", yyvsp[-1]); }
#line 1125 "y.tab.c"
    break;
